...
type CollegeType = {
  ...
  name: string;
  address: string;
  image: string; // Update this to match the actual type
  shortaddress: string;
  owner: string;
  fees: string;
  naac: number;
...
const Colleges = () => {
  ...
  return (
    <div className="flex w-full p-[5%_5%_0_5%]">
            ...
            <div key={index} className="mb-4 flex rounded border p-4 shadow ">
              ...
              <section className="mt-4">
                <div className="flex">
                      ...
                      <svg xmlns="http://www.w3.org/2000/svg" fill="#155E75"  viewBox="0 0 512 512"  width={18}>
                ...
                <div className="flex mt-[5vh]">
                  <div className="">
                    ...
                    <span className="ml-2 text-lg">{college.shortaddress}</span>
                  </div>
                  <div className="ml-16">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="ml-2 text-lg">{college.owner}</span>
                  </div>
                </div>
